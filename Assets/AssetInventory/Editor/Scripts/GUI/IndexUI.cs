...
namespace AssetInventory
{
    public partial class IndexUI : BasicEditorUI
    {
        ...
        {
            AssetInventory.OnIndexingDone += OnIndexingDone;
...
#pragma warning restore CS4014
        ...
        private void ReloadLookups(bool force = true)
        {
            ...
            _expertSearchFields = new[]
            {
                ...
                "Asset/AssetRating", "Asset/AssetSource", "Asset/Backup", "Asset/CompatibilityInfo", "Asset/CurrentState", "Asset/CurrentSubState", "Asset/Description", "Asset/DisplayCategory", "Asset/DisplayName", "Asset/DisplayPublisher", "Asset/ETag", "Asset/Exclude",
                "Asset/FirstRelease", "Asset/ForeignId", "Asset/Hotness", "Asset/Hue", "Asset/Id", "Asset/IsHidden", "Asset/IsLatestVersion", "Asset/KeepExtracted", "Asset/KeyFeatures", "Asset/Keywords", "Asset/LastOnlineRefresh", "Asset/LastRelease", "Asset/LatestVersion",
                "Asset/License", "Asset/LicenseLocation", "Asset/Location", "Asset/OriginalLocation", "Asset/OriginalLocationKey", "Asset/PackageSize", "Asset/PackageSource", "Asset/ParentId", "Asset/PriceCny", "Asset/PriceEur", "Asset/PriceUsd", "Asset/PublisherId",
                "Asset/PurchaseDate", "Asset/RatingCount", "Asset/Registry", "Asset/ReleaseNotes", "Asset/Repository", "Asset/Requirements", "Asset/Revision", "Asset/SafeCategory", "Asset/SafeName",
        ...
        public override void OnGUI()
        {
            ...
            if (!searchMode)
            {
                ...
                if (isNewTab) AssetInventory.StopAudio();
                EditorGUILayout.Space();
            }
            else
            {
            ...
            if (_allowLogic)
            {
                ...
                {
                    if (_mouseOverSearchResultRect && (searchMode || AssetInventory.Config.doubleClickBehavior > 0) && _selectedEntry != null)
                    {
                        if (searchMode)
                        {
                            ExecuteSingleAction();
                        ...
                        {
                            if ((AssetInventory.Config.doubleClickBehavior == 1 && !Event.current.alt) || (AssetInventory.Config.doubleClickBehavior == 2 && Event.current.alt))
                            {
#pragma warning disable CS4014
...
#pragma warning restore CS4014
        ...
        private bool DrawToolbar()
        {
            ...
            if (GUILayout.Button(EditorGUIUtility.IconContent(AssetInventory.Config.hideAdvanced ? "d_animationvisibilitytoggleoff" : "d_animationvisibilitytoggleon", "|Visibility of Advanced Features" + (AssetInventory.Config.hideAdvanced ? " - Hold CTRL to show temporarily" : "")), EditorStyles.label))
            {
                AssetInventory.Config.hideAdvanced = !AssetInventory.Config.hideAdvanced;
                AssetInventory.SaveConfig();
            }
        ...
        private static void GUILabelWithText(string label, string text, int width = 95, string tooltip = null, bool wrappable = false)
        {
            GUILayout.BeginHorizontal();
        ...
        // shortcut
        private static bool ShowAdvanced() => AssetInventory.ShowAdvanced();
