    ...
    internal sealed class ReportTreeViewControl : TreeViewWithTreeModel<AssetInfo>
    {
        ...
        private void CellGUI(Rect cellRect, TreeViewItem<AssetInfo> item, Columns column, ref RowGUIArgs args)
        {
            ...
            switch (column)
            {
                ...
                case Columns.Version:
                    ...
                    EditorGUI.LabelField(versionRect, version, isAccurate ? EditorStyles.boldLabel : EditorStyles.label);
                    ...
                    if (updateAvailable)
                    {
                        ...
                        statusRect.x += Mathf.Min(size.x, cellRect.width - 16) + 2;
                        statusRect.y += 1;
                        statusRect.width = 16;
        ...
        public static MultiColumnHeaderState CreateDefaultMultiColumnHeaderState(float treeViewWidth)
        {
            MultiColumnHeaderState.Column[] columns =
            {
                ...
                new MultiColumnHeaderState.Column
                {
                    headerContent = new GUIContent("License"),
                    contextMenuText = "License",
