...
namespace AssetInventory
{
    public partial class IndexUI
    {
        ...
        private void DrawReportingTab()
        {
            ...
            {
                GUILabelWithText("Identified packages", $"{identifiedPackagesCount:N0}", width);
            ...
            GUILayout.BeginVertical();
            GUILabelWithText("Paid packages", $"{paidPackagesCount:N0}", width);
            GUILabelWithText("Used Licenses", $"{licenses}", width, null, true);
            GUILayout.EndVertical();
        ...
        private async void CalculateAssetUsage()
        {
            ...
            AssetInventory.ResolveParents(_assetUsage, _assets);
